...
Route::middleware(['auth', 'profile.completed'])->group(function () {
    ...
    // Location Data (Authenticated Users)
    ...
    // Payment Routes
    Route::middleware(['role:SILVERCHANNEL', 'active'])->prefix('payment')->name('payment.')->group(function () {
    ...
    Route::middleware(['role:SILVERCHANNEL', 'active'])->group(function () {
    ...
    Route::middleware(['role:SILVERCHANNEL', 'active'])->prefix('silverchannel')->name('silverchannel.')->group(function () {
        // Catalog
