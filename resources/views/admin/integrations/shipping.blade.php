                    ...
                    <div class="p-4 sm:p-6 text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <form action="{{ route('admin.integrations.update') }}" method="POST">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="btn-3d btn-3d-blue shimmer inline-flex justify-center py-2 px-4 rounded-md text-sm font-medium">
                            ...
                            <div x-show="showModal" class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                <form action="{{ route('admin.integrations.shipping.store-update') }}" method="POST">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        <button type="submit" class="w-full btn-3d btn-3d-blue shimmer inline-flex justify-center rounded-md px-4 py-2 text-base font-medium sm:ml-3 sm:w-auto sm:text-sm">
                                            Save Changes
                                        </button>
                                        <button type="button" @click="showModal = false" class="mt-3 w-full btn-3d btn-3d-gray shimmer inline-flex justify-center rounded-md px-4 py-2 text-base font-medium sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                            Cancel
                                        </button>
                                    </div>
                                </form>
