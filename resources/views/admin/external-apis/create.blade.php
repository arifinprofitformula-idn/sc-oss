        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.external-apis.store') }}" method="POST" x-data="{ authType: 'none' }">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="endpoint_url" class="block mt-1 w-full" type="url" name="endpoint_url" :value="old('endpoint_url')" required />
                            ...
                            <div class="flex items-center mt-8">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600" name="is_active" value="1" checked>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="parameters" name="parameters" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="3">{{ old('parameters', '{}') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <x-text-input id="rate_limit_requests" class="block mt-1 w-full" type="number" name="rate_limit_requests" :value="old('rate_limit_requests', 60)" required />
                            </div>
                            <div>
                                <x-input-label for="rate_limit_period" :value="__('Period (Seconds)')" />
                                <x-text-input id="rate_limit_period" class="block mt-1 w-full" type="number" name="rate_limit_period" :value="old('rate_limit_period', 60)" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-6 border-t pt-4 dark:border-gray-700">
                            ...
                            <div x-show="authType === 'api_key'" class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                                <div>
                                    ...
                                    <x-text-input id="auth_key" class="block mt-1 w-full" type="text" name="auth_credentials[key]" placeholder="X-API-KEY" />
                                </div>
                                <div>
                                    <x-input-label for="auth_value" :value="__('Key Value')" />
                                    <x-text-input id="auth_value" class="block mt-1 w-full" type="text" name="auth_credentials[value]" />
                                </div>
                                <div>
                            ...
                            <div x-show="authType === 'bearer'" class="p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                                ...
                                <x-text-input id="auth_token" class="block mt-1 w-full" type="text" name="auth_credentials[token]" />
                            </div>
                            ...
                            <div x-show="authType === 'basic'" class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                                <div>
                                    ...
                                    <x-text-input id="auth_username" class="block mt-1 w-full" type="text" name="auth_credentials[username]" />
                                </div>
                                <div>
                                    <x-input-label for="auth_password" :value="__('Password')" />
                                    <x-text-input id="auth_password" class="block mt-1 w-full" type="password" name="auth_credentials[password]" />
                                </div>
                            </div>
                        </div>
