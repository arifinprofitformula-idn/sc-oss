                    ...
                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        ...
                        <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6 relative">
                            <style>
                                ...
                                .spinner div:nth-child(1) { animation-delay: 0.15s; background-color: rgba(0,77,255,0.9); }
                                .spinner div:nth-child(2) { animation-delay: 0.3s; background-color: rgba(0,77,255,0.8); }
                                .spinner div:nth-child(3) { animation-delay: 0.45s; background-color: rgba(0,77,255,0.7); }
                                .spinner div:nth-child(4) { animation-delay: 0.6s; background-color: rgba(0,77,255,0.6); }
                                .spinner div:nth-child(5) { animation-delay: 0.75s; background-color: rgba(0,77,255,0.5); }
