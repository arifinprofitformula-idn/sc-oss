<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->user()->hasRole('SUPER_ADMIN') ? route('admin.dashboard') : route('dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="auth()->user()->hasRole('SUPER_ADMIN') ? route('admin.dashboard') : route('dashboard')" :active="auth()->user()->hasRole('SUPER_ADMIN') ? request()->routeIs('admin.dashboard') : request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="auth()->user()->hasRole('SUPER_ADMIN') ? route('admin.dashboard') : route('dashboard')" :active="auth()->user()->hasRole('SUPER_ADMIN') ? request()->routeIs('admin.dashboard') : request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
